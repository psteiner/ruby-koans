...
# A character class matches on the set of characters defined by the
# bracket expression. Alternation matches on the characters or phrases
# defined between each pipe symbol within the parentheses. Character classes
# match only character-by-character, whereas alternation matches the
# whole experession for each alternative.
